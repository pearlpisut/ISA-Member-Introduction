memberInfo = {
    1:{
        ...
        "description": "Finally we have Keane, the President of ISA!! He is always energetic and full of energy which lights up the mood in whatever room he steps into! ⚡ He's funny and likes to laugh a lot, which makes him easy to get along with. 😆 During his free time, he loves watching movies, hanging out with friends, and playing badminton! Anyways, if you see Keane around, don't be afraid to say hi, trust me, you won't be disappointed! 😉",
        "study": "IBBA / 1",
        "position": "President", 
    ...
    3:{
        ...
        "nationality": "Indonesian 🇮🇩",
        "description": "Our secretary right here loves to hike. Introducing Cedrick, the calm and cool guy 😉 (he hates noisy people like me lmao). You can also call him “Cang”. He has a unique clothing style and is always giving out dad jokes. His favorite genre is bedroom pop indie. Guess what? He listens to Clairo and girl in red.",
        "study": "GLEF / 1",
        "position": "Secretary",
    ...
    5:{
        ...
        "nationality": "Hong Kong 🇭🇰 Japanese 🇯🇵",
        "description": "Next up we have Sushi, our ISA Treasurer!!! Not only is he committed to ISA, he has 6 other ongoing societies 🤩 who else is impressed with that! Aside from committee work, he enjoys gaming 🎮, watching kdramas 📺, Formula 1 🏎, and clubbing.",
        "study": "ECON / 1",
        "position": "Treasurer",
    ...
    6:{
        ...
        "nationality": "Thai 🇹🇭",
        "description": "Introducing our IT Officer: Pearl, from Thailand, is a proud Morningsider. He is one of the funniest ExCo in this year's cabinet, or at least we think he is🤣. But don’t underestimate him since he is one of the most creative and hardworking people that we know! His commitment to his work as an ExCo inspires us to do better! He loves Thai food, basketball, and reading! Pearl is fun to talk to and outgoing! So just dm him if you want to hangout😉!",
        "study": "ELEG / 1",
        "position": "IT Officer",
    ...
    7:{
        ...
        "description": "Now, let us introduce our savvy PR officer-Anujit from Bangladesh !!🎉 You can be sure to find him when you are looking for a hiking mate, decent chef, or even someone to have a lil' chat with about politics. If you don't see him chillaxing at his fav spot 😎, the rooftop of WYS, you may assume he is busy thinking of captions for our ISA post (literally) or responding to your DMs 🤣.",
        "study": "BMEG / 1",
        "position": "PR Officer",
